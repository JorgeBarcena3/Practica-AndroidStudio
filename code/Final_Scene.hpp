...
namespace project_template {
    ...
    private:
        ...
        //Puntero al boton de reinicio
        GameObject* reinicio_button_pointer;
        //Puntero al boton de menu
        GameObject* menu_button_pointer;
        //ALmacena la puntuacion del jugador
        int puntuacion = 0;


    public:
        Final_Scene(int puntuacion);
